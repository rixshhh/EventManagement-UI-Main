        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-8 shadow-2xl">
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="grid grid-cols-2 gap-4 min-w-[320px]">
              <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                ...
                <p className="text-3xl font-bold text-indigo-400">#{data.id}</p>
              </div>
          ...
          <div className="relative mt-8">
            <button
              onClick={handleJoin}
              disabled={isPending}
              className="w-full sm:w-auto px-8 py-3 rounded-2xl bg-indigo-500 hover:bg-indigo-600 transition text-white font-semibold shadow-lg disabled:opacity-50"
            >
